...
let frfr = [
    ...
    "Did you know that Many oranges are actually green?",
    "Did you know that honey never spoils?",
    "Did you know that no number from 1 to 999 includes the letter “a” in its word form?",
    "Did you know that the opposite sides of a die will always add up to seven?",
    "Did you know that youi are 13.8 percent more likely to die on your birthday?",
    ...
    "Did you know that 'dreamt' is the only English word that ends in the letters 'mt'?",
    "Did you know that a Greek-Canadian invented Hawian Pizza?",
    "Did you know that if you open your eyes in a dark room, the color you'll see is called 'eigengrau'?", 
    "Did you know that cats can't taste sweet things becuase of a gentic defect?",
    "Did you know that a group of hippos is calles a bloat?",
    ...
    "Did you know that Alaska is the only state whose name is on one row of the keyboard?",
    "Did you know that the unicorn is the national animal of Scotland?",
    "Did you know that Coca-Cola would be green if coloring was not added to it?",
]
